...
def elegir_testimonio(buscar,tipo):
    ...
    equivocado="No determinaste al responsable"
    correcto="Determinaste al responsable correctamente"
    if tipo == 0:
        if buscar == 1:
            return testimonio1
        if buscar == 2:
...
if respuestas_correctas == 3:
    ...
    print("\nPerdiste, no determinaste a todos los elementos correctamente.")